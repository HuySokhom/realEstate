...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 22, 2015 at 06:38 PM
...
CREATE TABLE IF NOT EXISTS `customers` (
  ...
  `customers_type` enum('','personal_type','wholesaler_type','','') COLLATE utf8_unicode_ci NOT NULL,
  ...
  `customers_province` varchar(115) COLLATE utf8_unicode_ci NOT NULL,
  `customers_app_id` enum('','whats_app','we_chat') COLLATE utf8_unicode_ci NOT NULL,
  `customers_company_name` varchar(115) COLLATE utf8_unicode_ci NOT NULL,
  `customers_contact_name` varchar(115) COLLATE utf8_unicode_ci NOT NULL,
