<?php
  ...
  define('HTTP_COOKIE_PATH', '/realEstate/adminSingaProperty');
  define('HTTPS_COOKIE_PATH', '/realEstate/adminSingaProperty');
  define('HTTP_CATALOG_SERVER', 'http://localhost');
  define('HTTPS_CATALOG_SERVER', 'http://localhost');
  define('ENABLE_SSL_CATALOG', 'false');
  define('DIR_FS_DOCUMENT_ROOT', '/var/www/osCommerce/');
  define('DIR_WS_ADMIN', '/realEstate/adminSingaProperty/');
  define('DIR_WS_HTTPS_ADMIN', '/realEstate/adminSingaProperty/');
  define('DIR_FS_ADMIN', '/var/www/realEstate/adminSingaProperty/');
  define('DIR_WS_CATALOG', '/realEstate/');
  define('DIR_WS_HTTPS_CATALOG', '/realEstate/');
  define('DIR_FS_CATALOG', '/var/www/realEstate/');
