...
// login content module must return $login_customer_id as an integer after successful customer authentication
  ...
  if ( is_int($login_customer_id) && ($login_customer_id > 0) ) {
    ...
    $customer_info_query = tep_db_query("select c.customers_firstname, c.customers_plan, c.user_type, c.user_name, c.customers_lastname, c.customers_default_address_id, ab
