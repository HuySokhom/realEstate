...
class RestApiSessionUserPlanUpgrade extends RestApi {
	...
	public function post($params){
		...
		if( !$userId ){
			...
			$count = tep_db_query("select count(id) as total, id from customers_plan_upgrade where customers_id = '" . $userId . "'");
