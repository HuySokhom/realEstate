...
define('TEXT_ORIGIN_LOGIN', '<font color="#FF0000"><small><strong>ចំណាំ:</strong></small></font> បើអ្នកមានគណនីមួយរួចទៅហើយជាមួយយើង, សូមចូលនៅ <a href="%s"><u>ទំព័រចូល</u></a>.');
...
define('MODULE_CONTENT_LOGIN_HEADING_NEW_CUSTOMER', 'ចុះឈ្មោះថ្ងៃនេះនិងរីករាយជាមួយ :');
